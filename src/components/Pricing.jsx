                ...
                rounded-lg shadow-3xl'>
                    ...
                    <ul className='mt-4 space-y-2 px-4'>
                        <li className='flex gap-3 items-center'>
                            <img src={pkg.greenthick} alt="" className='w-5 h-5'/>Videos of lesson
                        </li>
                        <li className='flex gap-3 items-center'>
                            <img src={pkg.greenthick} alt="" className='w-5 h-5'/>Homework check
                        </li>
                        <li className='flex gap-3 items-center'>
                            <img src={pkg.greenthick} alt="" className='w-5 h-5'/>Additional practical task
                        </li>
                        <li className='flex gap-3 items-center'>
                            <img src={pkg.greenthick} alt="" className='w-5 h-5'/>Monthly conferences 
                        </li>
                        <li className='flex gap-3 items-center'>
                            <img src={pkg.greenthick} alt="" className='w-5 h-5'/>Consultation with Teachers
                        </li>
                    </ul>
                </div>)
            }
